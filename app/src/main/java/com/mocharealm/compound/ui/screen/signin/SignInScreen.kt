        ...
        item {
            AnimatedContent(
                when (state.authState) {
                    is AuthState.WaitingForPhoneNumber, is AuthState.WaitingForOtp -> "OtpPhase"
                    is AuthState.WaitingForPassword -> "PasswordPhase"
                    is AuthState.Error -> "ErrorPhase"
                    else -> "Other"
                },
                transitionSpec = {
